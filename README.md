...
- You need to create your own SSL certificates and CA and change their address in client.py and server.py and the server IP (according to the domain name of the server certificate) in client.py.</br>
